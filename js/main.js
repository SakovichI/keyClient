...
/* harmony import */ var _components_amount__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/amount */ "./src/js/components/amount.js");
/* harmony import */ var _components_amount__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_amount__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _functions_select__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/select */ "./src/js/functions/select.js");
...
const btnPlus = document.querySelector(".btns-prod__btn-plus");
const btnMinus = document.querySelector(".btns-prod__btn-minus");
let amount = document.querySelector(".btns-prod__amount");
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".block-slider", {
  slidesPerView: "1",
  init: false,
  on: {
    init: function () {
    ...
    slideChange: function () {
      menuSlideRemove();
      menuSlide();
      menuLinks[swiper.realIndex].classList.add("slider-nav__item--active");
    }
  }
});
let menuLinks = document.querySelectorAll(".slider-nav__item");
function menuSlide() {
  if (menuLinks.length > 0) {
    ...
    for (let index = 0; index < menuLinks.length; index++) {
      ...
      menuLink.addEventListener("click", function (e) {
        ...
        menuLink.classList.add("slider-nav__item--active");
      });
    }
  }
}
function menuSlideRemove() {
  let menuLinkActive = document.querySelector(".slider-nav__item--active");
  if (menuLinkActive) {
    menuLinkActive.classList.remove("slider-nav__item--active");
  }
}
swiper.init();
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.content-modal__form', rules, afterForm);
